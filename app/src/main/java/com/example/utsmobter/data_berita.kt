...
import kotlinx.android.synthetic.main.activity_data_berita.*
import org.json.JSONObject

class data_berita : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnbackdata.setOnClickListener{
            startActivity(Intent(this@data_berita,dashboard::class.java))
            finish()
        }
        ...
        AndroidNetworking.get("http://192.168.100.26/utsmobter/data_berita.php")
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject) {
                    ...
                    for (i in 0 until jsonArray.length()) {
                        ...
                        var isi2=jsonObject.optString("isi_berita").toString()
